...
## 4. Review iris_sklearn.py and the configuration files
...
## 5. Run iris_sklearn.py in your local environment
...
### 6.1. Run scripts in local Docker environments
...
### 6.2. Run experiments on Docker in a local machine
...
### 6.3. Run scripts in remote Docker environments
