...
4. __Open__ **run.py** in Code and **change** **local** to **docker-python** in line 9. Save the change.
...
To save time, use Instructor's DSVM for Linux Ubuntu for following lab:
  |key|value|
  |---|---|
  |<REMOTE_VM>| key|
  |<IP_ADDRESS>|key|
...
> [Tutorial 3 - Deploy models](./03.DeployModel.md)
